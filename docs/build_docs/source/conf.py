...
latex_documents = [
    (master_doc, 'analogs_finder.tex', 'pele_platform documentation',
...
texinfo_documents = [
    (master_doc, 'pele_platform', 'pele_platform documentation',
     author, 'pele_platform', 'find analogs by making queries to your own database',
     'Miscellaneous'),
]
